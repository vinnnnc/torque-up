...
const SHAFT_OUTER_RADIUS: float = 24.0
...
const GEAR_MESH_CONTACT_MARGIN: float = 2.0
const DEFAULT_SOCKET_RADIUS: float = DEFAULT_GEAR_OUTER_RADIUS * 2.0
const DEFAULT_SOCKET_COUNT: int = 8
const DEFAULT_SNAP_MAX_DISTANCE: float = 64.0
const DEFAULT_PLACEMENT_CLEARANCE: float = DEFAULT_SOCKET_RADIUS - 2.0
...
const TORQUE_NODE_OUTPUT: float = 70.0
const SPEED_NODE_OUTPUT: float = 40.0
