...
- [placement-and-editor.md](placement-and-editor.md): snapping, socket rules, and dev editor tooling
...
- HUD currently shows generator load torque and a run timer. The horsepower row is present in the scene tree but displays empty in the current build.
- Shaft, chain, flywheel, clutch, and differential exist as disabled hotbar stubs. None have active placement handlers or simulation scripts in this build.
